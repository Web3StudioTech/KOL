                ...
                <div style={{ display:'flex', flexDirection:'column', gap:'10px' }}>
                  <div style={{ padding:'12px 14px', background:'var(--bg3)', border:'1px solid var(--border)', borderRadius:'3px' }}>
                    <div style={{ display:'flex', alignItems:'center', gap:'8px', marginBottom:'4px' }}>
                      <img src="/badges/kol-badge.png" alt="KOL Badge" style={{ width:32, height:32, objectFit:'contain', background:'#080b0f', borderRadius:'6px' }} />
                    ...
                    <p style={{ fontSize:'12px', color:'var(--muted)', lineHeight:1.5 }}>
                      Verify Twitter with 5,000+ followers. Submit up to 3 calls per day. Earn 0.05% from the KOL reward pool on every trade your call generates.
                    </p>
                  </div>
                  <div style={{ padding:'12px 14px', background:'var(--bg3)', border:'1px solid var(--border)', borderRadius:'3px' }}>
                    <div style={{ display:'flex', alignItems:'center', gap:'8px', marginBottom:'4px' }}>
                      <img src="/badges/trader-badge.png" alt="Trader Badge" style={{ width:32, height:32, objectFit:'contain', background:'#080b0f', borderRadius:'6px' }} />
                    ...
                    <p style={{ fontSize:'12px', color:'var(--muted)', lineHeight:1.5 }}>
                      Trade $50,000+ cumulative volume on OnchainKOL. Badge assigned automatically. Claim your Trader badge based on FCFS basis.
                    </p>
                  </div>
                </div>
              </div>
