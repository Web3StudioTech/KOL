...
export default function Nav() {
  ...
  const links = [
    ...
    { href: '/kolswap', label: 'KOLSwap' },
    { href: '/pass', label: 'Creator Badge' },
    ...
    <nav style={{
      ...
      <div style={{ display:'flex', alignItems:'center', gap:'12px' }}>
        <div style={{ display:'flex', alignItems:'center', gap:'6px' }}>
          <span style={{ width:'8px', height:'8px', borderRadius:'50%', background:'#00C805', display:'inline-block', boxShadow:'0 0 6px #00C805', animation:'pulse 1.5s infinite' }} />
          <span style={{ fontFamily:'Barlow Condensed,sans-serif', fontSize:'11px', fontWeight:700, letterSpacing:'2px', textTransform:'uppercase', color:'#00C805' }}>Robinhood Chain</span>
        </div>
